...
if(isset($_POST['submit'])){
    ...
    if (!empty($_POST['product_category_id']) && !empty($_POST['product_name_id'])) {
                        ...
                        <div class="form-row mb-3">
                            <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
                                ...
                                <select name="product_category_id" id="product_category_id" class="form-control" required>
                                    ...
                                    <?php
                                    $sql_pro_cate = "SELECT * FROM `product_category` WHERE `status`='1' ORDER BY `pro_cate_id` ASC";
              ...
              <div class="ln_solid"></div>
                <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <button type="submit" name="submit" class="btn btn-success">Search Product</button>
                  </div>
                </div>
            </form>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php
                        if (!empty($_GET['product_category_id']) && !empty($_GET['product_name_id'])) {

                            $product_category_id   = ucwords($connection->real_escape_string(mysql_entities_fix_string($_GET['product_category_id'])));
                            $product_name_id   = ucwords($connection->real_escape_string(mysql_entities_fix_string($_GET['product_name_id'])));
...
$(document).ready(function(){
    ...
    $("#product_category_id").change(function(){
        ...
        $.ajax({
            ...
            method: "POST",
            url   : "ajax/product_category_retrive_1.php",
            data  : { "product_category_id": product_category_id},
            success: function(response) {

                $("#product_name_id").html(response);
            }
        });
    });
});
