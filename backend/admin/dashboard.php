                ...
                <div class="tile-stats">
                  <div class="count">
                    ...
                    if ($result_products = $connection->query($sql_products))
                        $cnt_products = $result_products->num_rows;
              ...
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  <div class="count">
                    ...
                    if ($result_order = $connection->query($sql_order))
                        $cnt_order = $result_order->num_rows;
              ...
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  <div class="count">
                    ...
                    if ($result_category = $connection->query($sql_category))
                        $cnt_category = $result_category->num_rows;
